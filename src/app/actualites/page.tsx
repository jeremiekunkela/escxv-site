...
export const metadata: Metadata = {
  title: "Actualités",
  description: "Les dernieres actualites publiees par l'ESC XV et ses sections.",
};
  ...
  return (
    <>
      <HeroSection
        ...
        description="Retrouvez des apercus rapides sur les informations publiees par l'ESC XV, puis ouvrez chaque actualite dans une page detaillee avec contenu complet, images et informations complementaires."
