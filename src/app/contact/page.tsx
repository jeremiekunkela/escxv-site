  ...
  return (
    <>
      <HeroSection
        ...
        description="Une question sur une activité, une envie de nous rejoindre, une démarche administrative : choisissez votre destinataire, le message part directement dans sa boîte."
        ...
        <section className={`${styles.section} ${styles.gridSurface}`}>
          <Container>
            <div className={styles.header}>
              <SectionTitle
                eyebrow="Nous écrire"
                title="Un message, un destinataire"
              />
            </div>
