...
export const metadata: Metadata = {
  title: "Installations",
  description:
    "Les installations sportives de l'ESCXV dans le 15e arrondissement de Paris : gymnases, stades, piscines et salles, avec les sports pratiques sur chaque site.",
};
  ...
  return (
    <>
      <HeroSection
        ...
        description="Gymnases, stades, piscines et salles : retrouvez toutes les installations de l'ESCXV dans le 15e arrondissement, les sports pratiques sur chaque site et leur equipement."
